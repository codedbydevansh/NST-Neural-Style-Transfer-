...
def parse_arguments():
    ...
    parser.add_argument('--content_dir' , type=str , default='C:/Users/deeva/Desktop/NST Project/content_data' , help='Location of content dataset')
    parser.add_argument('--style_dir' , type=str , default='C:/Users/deeva/Desktop/NST Project/style_data' , help='Location of style dataset')
    parser.add_argument('--vgg' , type=str , default='C:/Users/deeva/Desktop/NST Project/vgg_normalised.path' , help='Location of pre-trained VGG')
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        for content_batch , style_batch in progress_bar:
            ...
            progress_bar.set_description(f"Loss:{loss.item()}, Content Loss:{loss_c.item()}, Style Loss : {loss_s.item()}")
        ...
        if (epoch+1) % args.save_interval == 0:
            ...
            with torch.no_grad():
                output = torch.cat([content_batch , style_batch , g] , dim =0) # type: ignore
