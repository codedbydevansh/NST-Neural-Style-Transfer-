...
def adaptive_instance_normalization(content_feat , style_feat):
    ...
    normalized_content_fead = (content_feat - content_mean.expand(size)) / content_std.expand(size)
    return normalized_content_fead * style_std.expand(size) + style_mean.expand(size)
